...
import { BrowserController } from "@cryptkeeper/controllers";
import { cryptoGenerateEncryptedHmac, cryptoGetAuthenticBackupCiphertext } from "packages/services/src/crypto";
import HistoryService from "packages/services/src/history";
import LockerService from "packages/services/src/lock";
import NotificationService from "packages/services/src/notification";
import SimpleStorage from "packages/services/src/storage";
import { ZkIdentitySemaphore } from "packages/services/src/zkIdentity/protocols/ZkIdentitySemaphore";
import { getEnabledFeatures } from "packages/config/src/features";
import { Paths } from "packages/extension/src/constants";
import { IdentityMetadata, IdentityName, NewIdentityRequest, OperationType, SelectedIdentity } from "@cryptkeeper/types";
...
import type { IBackupable } from "packages/services/src/backup";
