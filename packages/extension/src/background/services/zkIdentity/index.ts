...
import BrowserUtils from "packages/extension/src/background/controllers/browserUtils";
import { cryptoGenerateEncryptedHmac, cryptoGetAuthenticBackupCiphertext } from "packages/extension/src/background/services/crypto";
import HistoryService from "packages/extension/src/background/services/history";
import LockerService from "packages/extension/src/background/services/lock";
import NotificationService from "packages/extension/src/background/services/notification";
import SimpleStorage from "packages/extension/src/background/services/storage";
import { ZkIdentitySemaphore } from "packages/extension/src/background/services/zkIdentity/protocols/ZkIdentitySemaphore";
import { getEnabledFeatures } from "packages/extension/src/config/features";
import { Paths } from "packages/extension/src/constants";
import { IdentityMetadata, IdentityName, NewIdentityRequest, OperationType, SelectedIdentity } from "packages/extension/src/types";
import { setIdentities, setSelectedCommitment } from "packages/extension/src/ui/ducks/identities";
import { ellipsify } from "packages/extension/src/util/account";
import pushMessage from "packages/extension/src/util/pushMessage";

import type { IBackupable } from "packages/extension/src/background/services/backup";
