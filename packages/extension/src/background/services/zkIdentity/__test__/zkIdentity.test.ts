...
import ZkIdentityService from "packages/extension/src/background/services/zkIdentity";
...
import { CreateIdentityOptions, IdentityStrategy } from "packages/extension/src/types";
import { setSelectedCommitment } from "packages/extension/src/ui/ducks/identities";
