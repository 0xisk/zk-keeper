...
import { createModalRoot, deleteModalRoot } from "packages/extension/src/config/mock/modal";
import { defaultWalletHookData } from "packages/extension/src/config/mock/wallet";
import { IUseConnectionModalData, useConnectionModal } from "packages/extension/src/ui/components/ConnectionModal/useConnectionModal";
import { sliceAddress } from "packages/extension/src/util/account";
