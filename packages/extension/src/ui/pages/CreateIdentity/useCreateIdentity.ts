...
import { WEB2_PROVIDER_OPTIONS, IDENTITY_TYPES, Paths } from "packages/extension/src/constants";
import { IdentityStrategy, IdentityWeb2Provider, SelectOption } from "packages/extension/src/types";
import { closePopup } from "packages/extension/src/ui/ducks/app";
