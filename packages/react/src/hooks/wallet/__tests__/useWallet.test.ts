...
import { getWalletConnection, lock, setWalletConnection, useAppStatus } from "@src/ducks/app";
...
jest.mock("@src/ducks/app", (): unknown => ({
...
jest.mock("@src/ducks/hooks", (): unknown => ({
  useAppDispatch: jest.fn(),
}));

describe("hooks/wallet", () => {
